...
class FeedPageLocators:
    ...
    COMPLETED_ORDERS_TOTAL = By.XPATH, ('//p[text()="Выполнено за все время:"]/following-sibling::p[contains(@class,'
                                        '"digits-large")]')  # количество заказов, выполненных за все время
    COMPLETED_ORDERS_TODAY = By.XPATH, ('//p[text()="Выполнено за сегодня:"]/following-sibling::p[contains(@class,'
                                        '"digits-large")]')  # количество заказов, выполненных за сегодня
    ...
    NO_ORDERS_IN_WORK_TITLE = By.XPATH, '//li[text()="Все текущие заказы готовы!"]'  # текст "Все текущие заказы
    # готовы!" под заголовком "В работе"
